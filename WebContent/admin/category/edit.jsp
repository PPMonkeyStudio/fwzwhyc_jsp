	...
	<div class="formbody">
		...
		<form action="${path}category?option=updateCategory" name="ff" method="post"
			...
			<ul class="forminfo">
				...
				<li><label style="width: 120px;">类别id：</label><input id="cid"
					name="cid" value="${category.cid}" type="text" class="dfinput"
					readonly="true" /><i>类别id为纯数字</i></li>
				<li><label style="width: 120px;">类别名称（<font
						style="color: Red; font-weight: bolder;">*</font>）：
				</label><input id="cname" name="cname" value="${category.cname}" type="text"
					class="dfinput" /><i>类别名称</i></li>
				<li><label>&nbsp;</label><input name="" type="submit"
					class="btn" value="确认保存" /> &nbsp;&nbsp;<input name=""
